...
```{r business, echo = F, fig.align = "center", message = F, fig.height = 3.5}
...
```{r attributes, echo = FALSE, fig.align = "center"}
...
##Conclusion
In conclusion, we investigated several questions related to the Yelp academic dataset, and our results were promising. 
