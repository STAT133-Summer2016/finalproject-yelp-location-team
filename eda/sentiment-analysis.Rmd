...
wordcloud::wordcloud(one$word, one$n, scale = c(5, 0.5),
                     random.order = F, random.color = F,
                     use.r.layout = T,
                     colors = RColorBrewer::brewer.pal(10, "Reds"))
```
