...
```{r}
us_business <- read_csv('../clean_data/us-business.csv', stringsAsFactors=FALSE)
noise_level <- read_csv('../clean_data/noise-attr.csv', stringsAsFactors=FALSE) 
attire_type <- read_csv('../clean_dta/attire-attr.csv', stringsAsFactors=FALSE)
